...
const insertImageEditorialMetadata = (imageMetadata) => {
    return db.query('INSERT INTO shutterstock_prueba (shutterstock_id, description, categories, keywords, displayname,  is_licensable, requested_date, filename, license_id) VALUES (?,?,?,?,?,?,?,?,?)', 
    [
        imageMetadata.shutterstock_id,
        imageMetadata.description,
        imageMetadata.categories,
